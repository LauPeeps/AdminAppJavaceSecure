    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            updateBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (editCategoryName.getText().toString().isEmpty()) {
                        editCategoryName.setError("Please enter new module name");
                        return;
                    }
        ...
        private void deleteCategory(final int id, Context context, CategoryAdapter categoryAdapter) {
            ...
            for (int i = 0; i < category_list.size(); i++) {
                if (i != id) {
                    category_doc.put("Module" + String.valueOf(index) + "_Id", category_list.get(i).getId());
                    category_doc.put("Module" + String.valueOf(index) + "_name", category_list.get(i).getName());
                    index++;
                }
            }

            category_doc.put("Exist", index - 1);
