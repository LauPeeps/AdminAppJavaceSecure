...
import com.example.javaceadminapp.ForumModel;
...
public class ForumAdapter extends RecyclerView.Adapter<com.example.javaceadminapp.ForumAdapter.MyHolder> {
    ...
    public ForumAdapter(Context context, List<ForumModel> modelPosts) {
